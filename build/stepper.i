...
# 391 "/usr/local/include/pigpio.h" 3
extern "C" {
...
# 5038 "/usr/local/include/pigpio.h" 3
}
# 2 "source/stepper.cpp" 2
...
# 4 "source/stepper.cpp" 2
# 1 "source/../libraries/direction.h" 1
...
int main(){
    ...
    gpioSetMode(dir.getA(),1);
    gpioSetMode(dir.getB(),1);
    gpioSetMode(dir.getC(),1);
    gpioSetMode(dir.getD(),1);
    ...
    gpioSetMode(forward, 0);
    gpioSetMode(reverse, 0);
    gpioSetMode(manual, 0);
    gpioSetMode(active, 0);
